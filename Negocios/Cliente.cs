...
namespace Negocios
{
    public class Cliente
    {
        ...
        {
            return ($"EXEC RegistrarCliente {idcliente},'{nombre}','{razonSocial}','{Observacion}',{idTipoIdentificacion},'{identificacion}','{telefono}','{correo}',{idMunicipio},{idProvincia},{idSector},'{direccion}',{idCentro},{1}");
        }
    }
}
